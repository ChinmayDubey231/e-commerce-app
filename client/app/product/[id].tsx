  ...
  return (
    <View className="flex-1 bg-white">
        ...
        <View className="px-5">
          ...
          <View className="flex-row justify-between items-start mb-2">
            ...
            <View className="flex-row justify-between items-start mb-2">
              ...
              <Text className="text-xs text-secondary ml-1">(120)</Text>
            </View>
          </View>
              ...
              <View className="flex-row gap-3 mb-6 flex-wrap">
                {product.sizes.map((size) => (
                  <TouchableOpacity
                    ...
                    className={`w-12 h-12 items-center justify-center border rounded-full ${selectedSize === size ? "bg-primary border-primary" : "border-gray-300 bg-white"}`}
                  >
                    <Text
          ...
          <Text className="leading-6 text-secondary mb-6">
            {product.description}
          </Text>
        </View>
      </ScrollView>
      ...
      <View
        ...
        className="absolute bottom-0 left-0 right-0 bg-white px-5 pt-6 border-t border-gray-100 flex-row justify-between items-center"
      >
        <TouchableOpacity
          onPress={handleAddToCart}
          className="flex-1 h-16 bg-primary rounded-full items-center justify-center flex-row shadow-lg mr-2"
        >
          <Ionicons name="bag-outline" size={20} color="white" />
          <Text className="text-white font-bold text-xl ml-2">Add to Cart</Text>
        </TouchableOpacity>
        ...
        >
          ...
          {itemCount > 0 && (
            <View className="absolute top-1 right-1 w-4 h-4 bg-black rounded-full justify-center items-center">
